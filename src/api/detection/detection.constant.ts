...
export const skinConditions: { [key: number]: SkinConditionDto } = {
  ...
  1: {
    commonName: 'Bula/lepuh',
    medicalName: 'Bullous Disease',
    assessment:
  ...
  3: {
    commonName: 'Ruam oleh virus',
    medicalName: 'Exanthems and Drug Eruptions',
    assessment:
  ...
  5: {
    commonName: 'Herpes',
    medicalName: 'Herpes HPV and other STDs',
    assessment:
  ...
  6: {
    commonName: 'Lupus',
    medicalName: 'Lupus and other Connective Tissue Diseases',
    assessment:
  ...
  7: {
    commonName: 'Melanoma',
    medicalName: 'Melanoma Skin Cancer Nevi and Moles',
    assessment:
  ...
  8: {
    commonName: 'Jamur Kuku',
    medicalName: 'Nail Fungus and other Nail Disease',
    assessment:
  ...
  9: {
    commonName: 'Kudis',
    medicalName: 'Scabies Lyme Disease and other Infestations and Bites',
    assessment:
  ...
  10: {
    commonName: 'Benjolan/tumor jinak',
    medicalName: 'Seborrheic Keratoses and other Benign Tumors',
    assessment:
  ...
  11: {
    commonName: 'Kurap',
    medicalName: 'Tinea Ringworm Candidiasis and other Fungal Infections',
    assessment:
  ...
  13: {
    commonName: 'Tumor Vaskuler',
    medicalName: 'Vascular Tumors',
    assessment:
  ...
  14: {
    commonName: 'Vaskulitis',
    medicalName: 'Vasculitis',
    assessment:
  ...
  15: {
    commonName: 'Kutil',
    medicalName: 'Warts Molluscum and other Viral Infections',
    assessment:
